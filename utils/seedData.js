...
const MOCK_BREATHING_TECHNIQUES = [
  {
    ...
    subtitle: 'Stress & Focus • Tactical Calm',
    badgeTag: 'STRESS',
    category: 'Breathing',
    totalRounds: 3,
    durationMinutes: 5,
    heroImageUrl: 'https://images.unsplash.com/photo-1448375240586-882707db888b?q=80&w=1200&auto=format&fit=crop',
    ...
    holdSeconds: 4,
    exhaleSeconds: 4,
    whatIs: 'Used by Navy SEALs to lower heart rate and enter peak calm concentration.',
    benefits: 'Lowers cortisol stress hormone, enhances mental clarity, and balances autonomic nervous system.',
    correctPosture: 'Sit upright in a comfortable position with shoulders relaxed.',
    instructions: 'Inhale 4s, hold 4s, exhale 4s, hold 4s.',
    howToDo: 'Breathe in through nose for 4s, hold for 4s, exhale through mouth for 4s, hold empty for 4s.',
    whatItDoesntGuarantee: 'Helps lower acute stress but does not replace clinical therapy.',
    contraindications: 'Reduce hold duration if feeling lightheaded or pregnant.',
    originHistory: 'Developed for tactical focus and stress reduction.',
    order: 1,
    isActive: true
  },
  {
