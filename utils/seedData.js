const MOCK_USERS = [
  {
    ...
    devicesConnected: ['Apple Watch Series 9', 'Oura Ring Gen 3'],
    lastSession: '12 mins ago (Sun Salutation A)',
    hrvAvg: '68 ms',
    sleepScore: '88/100',
  ...
  },
  {
    ...
    plan: 'Monthly Pro ($14.99/mo)',
    planType: 'Premium',
    status: 'Active',
    joinedDate: '2024-02-01',
    streak: 18,
    totalMinutes: 2150,
    primaryGoal: 'Core Strength & Flexibility',
    devicesConnected: ['Garmin Fenix 7 Pro'],
    lastSession: '1 hour ago (Box Breathing 10m)',
    hrvAvg: '74 ms',
    sleepScore: '91/100',
  ...
  },
  {
    ...
    streak: 5,
    totalMinutes: 640,
    primaryGoal: 'Better Sleep & Relaxation',
    devicesConnected: ['Pixel Watch 2'],
    lastSession: 'Yesterday (Deep Sleep Nidra)',
    hrvAvg: '55 ms',
    sleepScore: '78/100',
    country: 'Canada',
    language: 'English',
  ...
  },
  {
    id: 'USR-6512',
    name: 'Dr. Liam Thorne',
    email: 'l.thorne@medcenter.org',
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=250',
    plan: 'Pro Lifetime ($499)',
    planType: 'Premium',
    status: 'Active',
    joinedDate: '2023-11-20',
    streak: 120,
    totalMinutes: 12400,
    primaryGoal: 'Mindfulness & HRV Optimization',
    devicesConnected: ['Apple Watch Ultra 2', 'Oura Ring Gen 3'],
    lastSession: '3 hours ago (Ujjayi Breathwork)',
    hrvAvg: '82 ms',
    sleepScore: '94/100',
    country: 'Germany',
    language: 'German',
  ...
  },
  {
    ...
    streak: 0,
    totalMinutes: 320,
    primaryGoal: 'Posture & Office Stretch',
    devicesConnected: [],
